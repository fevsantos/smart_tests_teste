...
ActiveRecord::Schema.define(version: 2022_05_26_174431) do
  ...
  create_table "student_answers", force: :cascade do |t|
    t.string "option"
    t.bigint "student_grade_id", null: false
    t.bigint "question_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["question_id"], name: "index_student_answers_on_question_id"
    t.index ["student_grade_id"], name: "index_student_answers_on_student_grade_id"
  end
